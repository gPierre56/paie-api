 ...
 *
 */
public class CotisationsImposablesDto {
	...
	public CotisationsImposablesDto(String libelle, BigDecimal base, BigDecimal tauxSalarial,
	...
	public CotisationsImposablesDto() {
		super();
	}

	@Override
	public String toString() {
		return "CotisationsImposablesDto [libelle=" + libelle + ", base=" + base + ", tauxSalarial=" + tauxSalarial
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CotisationsImposablesDto other = (CotisationsImposablesDto) obj;
		if (base == null) {
			if (other.base != null)
				return false;
